...
object Colors {
  ...
  private val cppHighlighter: SyntaxHighlighter by lazy {
  ...
  val C_INT_KEYWORD = CreateTAK(
      "C_INT_KEYWORD", getDefHl(CppTokenTypes.INT_KEYWORD)
  )
  val C_CHAR_KEYWORD = CreateTAK(
      "C_CHAR_KEYWORD", getDefHl(CppTokenTypes.CHAR_KEYWORD))
